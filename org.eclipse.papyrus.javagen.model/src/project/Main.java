...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		areas[0] = new Area(
				...
				new LocationController(new Point(-7.5, -5.0), 2.75, e), RoomType.Office, false//TODO roomtype surgery
			);
		
		areas[1] = new Area(
				new Boundary(5, 5, new Position(-5.0, -7.5)), 
				new LocationController(new Point(-2.5, -5.0), 2.75, e), RoomType.Office, false//TODO roomtype surgery
			);
		...
		areas[4] = new Area(
				...
				new LocationController(new Point(-2.5, 5.0), 2.75, e), RoomType.Office, false//TODO roomtype counsel
			);
